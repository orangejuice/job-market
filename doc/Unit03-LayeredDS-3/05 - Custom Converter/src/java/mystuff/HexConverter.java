 ...
 * @author Reiner
 */
@FacesConverter("hexconv")
// registering this converter as default for MyClass
// and provide it under name "hexconv"
// @FacesConverter(forClass=MyClass.class, value="hexconv") 
